...
const HUMAN_REVIEWS: ReviewItem[] = [
  ...
  },
  {
    ...
    rating: 5,
    date: '2026-02-12',
    title: 'Zero latency multiplayer arena on old school Chromebooks',
    body: 'The live multiplayer arena runs buttery smooth even on our 6-year-old school Chromebook fleet. Kids get so excited shouting out calculations. It has become the most requested activity on Friday afternoons.',
    verified: true,
    category: 'positive',
    helpfulCount: 51
  },
