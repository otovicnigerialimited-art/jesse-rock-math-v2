      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 glass rounded-3xl border border-deep-navy border-4 p-6 space-y-6">
          <div className="flex items-center justify-between border-b border-deep-navy border-4 pb-4">
            ...
            {hasGrandMaster && (
              <button onClick={() => setShowCert(true)} className="ml-4 px-3 py-1.5 bg-amber-500 text-amber-950 font-bold rounded-lg text-xs uppercase tracking-wider shadow-lg shadow-amber-500/20 hover:scale-105 transition-all flex items-center gap-1"><FileText size={14} /> Legendary Rockstar Certificate</button>
            )}
            </span>
          </div>
